...
![Version: 7.20.0-nightly-build.1](https://img.shields.io/badge/Version-7.20.0--nightly--build.1-informational?style=flat-square)
...
| ingress.pathType | string | `"Prefix"` | set ingress path type |
